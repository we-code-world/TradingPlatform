...
<div id="user_content">
    <div class="share">
        ...
        <div class="share_content">
            <c:if test="${empty requestScope.get('Sells')}">
                <div class="no_share">
                    <span>没有任何内容，去逛逛其它的吧！</span>
                </div>
            </c:if>
            <c:if test="${!empty requestScope.get('Sells')}">
                <c:forEach var="Sell" items="${requestScope.get('Sells')}">
                    <div class="story">
                        <a href="${pageContext.request.contextPath}${Sell.getPictureurl()}" class="head_img">
                                <img src="${pageContext.request.contextPath}${Sell.getPictureurl()}">
                        </a>
                        <span class="name" style="margin-left:30px;color: red">${Sell.getGoodsname()}</span>
                        <span class="text" style="overflow: hidden; outline: none;">${Sell.getData()}</span>
                        <div class="box">
                            <div class="box_content">
                                ...
                                <img src="${pageContext.request.contextPath}${Sell.getPictureurl()}" index="2">

                                <span class="com" style="display: none;left: 396.733px;"></span>
                            </div>
                            <div class="interact">
                                <span class="time">${Sell.showDate()}</span>
                                <span class="fa fa-trash fa-lg"><a href="${pageContext.request.contextPath}/Personal/Sell/delete?id=${Sell.getGoodsid()}&userid=${requestScope.get('user').getUserid()}">下架</a></span>
                            </div><br>
                            <div class="like_detail">
                                <div class="like_content">
                                    <span>上架时间：${Sell.showDate()}</span>
                                </div>
                            </div>
                        </div>
                    </div>
